  ...
  factory: (require) => {
    ...
    const copy = {
      zh: {
        ...
        derivedEmptySections: '所选技能未声明 Prompt 段关联：该技能只门控工具，没有需要压制的系统提示词段。',
        nameLabel: '能力标识符 (Key)',
      ...
      en: {
        ...
        derivedEmptySections: 'The selected skills declare no Prompt Sections: they gate tools only, so there is nothing to suppress.',
                    ...
                    isExpanded && React.createElement('div', { style: styles.cardBody },
                      ...
                      React.createElement('div', { style: styles.field },
                        ...
                        React.createElement(DerivedValues, {
                          ...
                          emptyText: t.derivedEmptySections,
                        }),
                      ),
                    ),
                  )
